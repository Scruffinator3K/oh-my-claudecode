...
describe('validateConfigPath', () => {
  ...
  const claudeConfigDir = resolve('/home/user/.claude');
  ...
  it('should reject paths without trusted subpath', () => {
    expect(validateConfigPath(resolve('/home/user/project/config.json'), home, claudeConfigDir)).toBe(false);
  });

  it('should accept paths under ~/.claude/', () => {
    expect(validateConfigPath(resolve('/home/user/.claude/teams/foo/config.json'), home, claudeConfigDir)).toBe(true);
  });

  it('should accept paths under project/.omc/', () => {
    expect(validateConfigPath(resolve('/home/user/project/.omc/state/config.json'), home, claudeConfigDir)).toBe(true);
  });
  ...
  it('should reject path traversal via ../ that escapes trusted subpath', () => {
    ...
    expect(validateConfigPath(resolve('/home/user/foo/.claude/../../evil.json'), home, claudeConfigDir)).toBe(false);
  });
});
